...
export const NotFound = () => {
  return (
    <main className="cover-container d-flex p-5 text-center my-5 flex-column justify-content-center">
      <p className="my-3"><img src={mindulImage} width="128"></img></p>
      ...
      <p className="lead my-3">
        <Link to="/mindulPage" className="btn btn-lg btn-secondary fw-bold border-dark bg-dark text-white">Home</Link>
      </p>
    </main>
  );
}